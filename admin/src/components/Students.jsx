...
function Students() {
  ...
  return (
    <div>
      <p class="text-lg text-gray-700 leading-relaxed pt-1  max-w-4xl mx-auto font-bold italic">
        "Students are not just recipients of knowledge, they are the future
        architects of a better world."
      </p>
      <div className="students flex">
        <img src={student} alt="" className="w-[30%]" />
