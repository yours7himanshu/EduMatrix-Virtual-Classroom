      ...
      <div className="bg-white p-4 rounded-lg shadow mb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex space-x-2">
            <button className="bg-indigo-100 text-indigo-800 px-4 py-2 rounded-md">All Loans</button>
            <button className="bg-gray-100 text-gray-800 px-4 py-2 rounded-md">On Time</button>
            <button className="bg-red-100 text-red-800 px-4 py-2 rounded-md">Overdue</button>
          </div>
        </div>
      </div>
                ...
                <tr key={loan.id}>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4 text-sm font-medium text-gray-900">{loan.bookTitle}</div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3 text-sm text-gray-500">{loan.memberName}</div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
